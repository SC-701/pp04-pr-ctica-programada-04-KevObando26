...
namespace Flujo
{
    public class VehiculoFlujo : IVehiculoFujo
    {
        ...
        public async Task<VehiculoDetalle> Obtener(Guid Id)
        {
            ...
            vehiculo.RegistroValido =
                await _registroReglas.VehiculoEstaRegistrado(vehiculo.Placa, vehiculo.CorreoPropietario);

            vehiculo.RevisionValida =
                await _revisionReglas.RevisionEsValida(vehiculo.Placa);
